    ...
    <div className="min-h-[40vh] flex items-center justify-center">
      <div className="max-w-(--breakpoint-xl) w-full mx-auto grid lg:grid-cols-2 gap-12 px-6 py-12">
        <div>
          ...
          >
            <Link href="#">
              Apply for 14 days trial <ArrowUpRight className="ml-1 size-4" />
            </Link>
          </Badge>
          <h1 className="mt-6 max-w-[17ch] text-4xl md:text-5xl lg:text-[2.75rem] xl:text-[3.25rem] font-semibold leading-[1.2]! tracking-[-0.035em]">
            ERP SAAS with various modules packed inside
          </h1>
          <p className="mt-6 max-w-[60ch] sm:text-lg text-foreground/80">
            Leverage your business with industry standard ERP modules like website builder,
            news/blog/magazine, survey, ads, ecommerce, CRM etc all together in one platform.
          </p>
